...
const dataset: StarchartDataset = {
  ...
  nodes: {
    M1: { name: "M1", enName: "M1", group: "Mercury", nextNodes: ["M2"] },
    M2: { name: "M2", enName: "M2", group: "Mercury", nextNodes: ["MJ"] },
    MJ: { name: "MJ", enName: "MJ", group: "Mercury", nextNodes: ["V1"] },
    V1: { name: "V1", enName: "V1", group: "Venus", nextNodes: ["V2"] },
    V2: { name: "V2", enName: "V2", group: "Venus", nextNodes: [] },
    D1: { name: "D1", enName: "D1", group: "Loop", nextNodes: ["C1", "Ghost"] },
    C1: { name: "C1", enName: "C1", group: "Loop", nextNodes: ["C2"] },
    C2: { name: "C2", enName: "C2", group: "Loop", nextNodes: ["C1"] },
    X1: { name: "X1", enName: "X1", group: "Orphan", nextNodes: ["X2"] },
    X2: { name: "X2", enName: "X2", group: "Orphan", nextNodes: ["X1"] },
    R1: { name: "R1", enName: "R1", group: "RelayStationSanctuary", nextNodes: [] },
  },
};
